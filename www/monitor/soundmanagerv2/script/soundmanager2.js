  ...
  function SoundManager(smURL, smID) {
    ...
    SMSound = function (oOptions) {
      ...
      this.play = function (oOptions, _updatePlayState) {
        ...
        _updatePlayState =
          _updatePlayState === undefined ? true : _updatePlayState; // default to true
        ...
        if (!_t.loaded) {
          if (_t.readyState === 0) {
            ...
            _s._wD(
              fN + '"' + _t.sID + '" is loading - attempting to play..',
              1
            );
          }
        } else {
        ...
        if (
          ...
          _s._wD(
            fN + '"' + _t.sID + '": Sound at end, resetting to position:0'
          );
          oOptions.position = 0;
        }
        ...
        if (_t.paused && _t.position && _t.position > 0) {
          ...
          if (
            ...
            if (_t.isHTML5 && !_t._html5_canplay) {
              ...
              _s._wD(
                fN + 'Beginning load of "' + _t.sID + '" for from/to case'
              );
      ...
      this.setAutoPlay = function (autoPlay) {
        _s._wD(
          "sound " + _t.sID + " turned autoplay " + (autoPlay ? "on" : "off")
        );
    ...
    */
    ...
    _setVersionInfo = function () {
      ...
      _s.movieURL = (
        _fV === 8 ? "soundmanager2.swf" : "soundmanager2_flash9.swf"
      ).replace(".swf", isDebug);

      _s.features.peakData =
        _s.features.waveformData =
        _s.features.eqData =
          _fV > 8;
    };
      ...
      if (!oSound._hasTimer) {
        ...
        if (!_likesHTML5 && _s.html5PollingInterval) {
          if (_h5IntervalTimer === null && _h5TimerCount === 0) {
            _h5IntervalTimer = window.setInterval(
              _timerExecute,
