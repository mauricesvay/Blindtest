...
(function (H) {
  function P(P, ca) {
    ...
    var ya,
      ...
      u,
      Ja,
      ta = n.match(/(ipad|iphone|ipod)/i),
      Ra = n.match(/firefox/i),
      Sa = n.match(/droid/i),
      x = n.match(/msie/i),
      Ta = n.match(/webkit/i),
      O = n.match(/safari/i) && !n.match(/chrome/i),
      Ua = n.match(/opera/i),
      ua = n.match(/(mobile|pre\/|xoom)/i) || ta,
      va =
        !ea.match(/usehtml5audio/i) &&
        !ea.match(/sm2\-ignorebadua/i) &&
        O &&
        !n.match(/silk/i) &&
        n.match(/OS X 10_6_([3-7])/i),
      wa = "undefined" !== typeof k.hasFocus ? k.hasFocus() : null,
      G = O && "undefined" === typeof k.hasFocus,
      Ka = !G,
      La = /(mp3|mp4|mpa)/i,
      xa = k.location ? k.location.protocol.match(/http/i) : null,
      Ma = !xa ? "http://" : "",
      Na =
        /^\s*audio\/(?:x-)?(?:mpeg4|aac|flv|mov|mp4||m4v|m4a|mp4v|3gp|3g2)\s*(?:$|;)/i,
      Oa = "mpeg4,aac,flv,mov,mp4,m4v,f4v,m4a,mp4v,3gp,3g2".split(","),
      Va = RegExp("\\.(" + Oa.join("|") + ")(\\?.*)?$", "i");
    this.mimePattern = /^\s*audio\/(?:x-)?(?:mp(?:eg|3))\s*(?:$|;)/i;
    this.useAltURL = !xa;
    this._global_a = null;
    if (ua && ((c.useHTML5Audio = !0), (c.preferFlash = !1), ta))
      z = c.ignoreFlash = !0;
    ...
    this.createSound = function (a) {
      ...
      if (aa(f)) ((b = d()), b._setup_html5(f));
      else {
        if (8 < j) {
          if (null === f.isMovieStar)
            f.isMovieStar =
              f.serverURL ||
              (f.type ? f.type.match(Na) : !1) ||
              f.url.match(Va);
    ...
    this.start = this.play = function (a, d) {
      if (!o || !c.ok())
        return (pa("soundManager.play(): " + E(!o ? "notReady" : "notOK")), !1);
      if (!p(a)) {
    ...
    this.canPlayMIME = function (a) {
      var d;
      c.hasHTML5 && (d = N({ type: a }));
      return !t || d
        ? d
        : a && c.ok()
          ? !!((8 < j && a.match(Na)) || a.match(c.mimePattern))
          : null;
    };
    this.canPlayURL = function (a) {
      var d;
      c.hasHTML5 && (d = N({ url: a }));
    ...
    this.onready = function (a, c) {
      if (a && a instanceof Function)
        return (c || (c = g), ha("onready", a, c), A(), !0);
    ...
    this.reboot = function () {
      ...
      for (a in q)
        if (q.hasOwnProperty(a))
          for (d = q[a].length - 1; 0 <= d; d--) q[a][d].fired = !1;
      g.setTimeout(c.beginDelayedInit, 20);
    };
    this.getMoviePercent = function () {
      return h && "undefined" !== typeof h.PercentLoaded
        ? h.PercentLoaded()
        : null;
    };
    ...
    ya = function (a) {
      ...
      this.load = function (a) {
        ...
        if ("undefined" !== typeof a)
          ((b._iO = s(a, b.options)), (b.instanceOptions = b._iO));
        else if (
          ((a = b.options),
          (b._iO = a),
      ...
      this.unload = function () {
        0 !== b.readyState &&
          (b.isHTML5
            ? (g(), b._a && (b._a.pause(), ra(b._a)))
            : 8 === j
              ? h._unload(b.sID, "about:blank")
              : h._unload(b.sID),
          f());
        return b;
      };
      ...
      this.start = this.play = function (a, c) {
        ...
        if (1 === b.playState && !b.paused && ((d = b._iO.multiShot), !d))
          return b;
        if (!b.loaded)
          if (0 === b.readyState) {
        ...
        if (b.paused && b.position && 0 < b.position) b.resume();
          ...
          if (
            ...
            if (b.isHTML5 && !b._html5_canplay)
              return (b.load({ _oncanplay: d }), !1);
            if (
              !b.isHTML5 &&
              !b.loaded &&
              (!b.readyState || 2 !== b.readyState)
            )
              return (b.load({ onload: d }), !1);
            b._iO = t();
          }
          (!b.instanceCount ||
      ...
      this.setPosition = function (a) {
        ...
        if (b.isHTML5) {
          ...
          ((a = 9 === j ? b.position : a),
            b.readyState &&
              2 !== b.readyState &&
              h._setPosition(b.sID, a, b.paused || !b.playState));
      ...
      this.pause = function (a) {
        ...
        b.paused = !0;
        b.isHTML5
          ? (b._setup_html5().pause(), g())
          : (a || void 0 === a) && h._pause(b.sID);
      ...
      this.clearOnPosition = function (b, a) {
        ...
        for (c = 0; c < n.length; c++)
          if (b === n[c].position && (!a || a === n[c].method))
            (n[c].fired && o--, n.splice(c, 1));
      };
      this._processOnPosition = function () {
        ...
        for (a -= 1; 0 <= a; a--)
          if (((c = n[a]), !c.fired && b.position >= c.position))
      ...
      this._resetOnPosition = function (b) {
        ...
        if (!a) return !1;
        for (a -= 1; 0 <= a; a--)
          if (((c = n[a]), c.fired && b <= c.position)) ((c.fired = !1), o--);
        return !0;
      };
      t = function () {
        var a = b._iO,
      ...
      i = function () {
        ...
        for (a in u)
          u.hasOwnProperty(a) && b._a && b._a.addEventListener(a, u[a], !1);
        return !0;
      };
      Pa = function () {
        var a;
        ...
        for (a in u)
          u.hasOwnProperty(a) && b._a && b._a.removeEventListener(a, u[a], !1);
      };
      ...
      this._whileplaying = function (a, c, d, e, f) {
        ...
        if (!b.isHTML5 && 8 < j) {
          if (i.usePeakData && "undefined" !== typeof c && c)
            b.peakData = { left: c.leftPeak, right: c.rightPeak };
          if (i.useWaveformData && "undefined" !== typeof d && d)
        ...
        1 === b.playState &&
          (!b.isHTML5 &&
            ...
            b.isBuffering &&
            b._onbufferchange(0),
          i.whileplaying && i.whileplaying.apply(b));
        return !0;
      };
    ...
    u = {
      ...
      progress: l(function (a) {
        ...
        isNaN(e) ||
          (c._onbufferchange(0),
          c._whileloading(e, i, c._get_html5_duration()),
          e && i && e === i && u.load.call(this, a));
      }),
    ...
    aa = function (a) {
      return (
        !a.serverURL &&
        (a.type ? N({ type: a.type }) : N({ url: a.url }) || c.html5Only)
      );
    };
    ra = function (a) {
    ...
    N = function (a) {
      ...
      if (!w) {
        ...
        for (f in b)
          b.hasOwnProperty(f) &&
            (w.push(f), b[f].related && (w = w.concat(b[f].related)));
        w = RegExp("\\.(" + w.join("|") + ")(\\?.*)?$", "i");
      }
    ...
    Ha = function () {
        ...
        if (a instanceof Array) {
          for (b = 0, e = a.length; b < e && !f; b++)
            if (c.html5[a[b]] || d.canPlayType(a[b]).match(c.html5Test))
              ((f = !0),
                (c.html5[a[b]] = !0),
                (c.flash[a[b]] = !(!c.preferFlash || !r || !a[b].match(La))));
          return f;
        }
      ...
      for (e in f)
        if (
          ...
          (b["audio/" + e] = b[e]),
          (c.flash[e] =
            c.preferFlash && !c.ignoreFlash && e.match(La) ? !0 : !1),
          f[e] && f[e].related)
        )
          for (i = f[e].related.length - 1; 0 <= i; i--)
            ((b["audio/" + f[e].related[i]] = b[e]),
              (c.html5[f[e].related[i]] = b[e]),
              (c.flash[f[e].related[i]] = b[e]));
    ...
    Ba = function (a) {
      for (var c in a)
        a.hasOwnProperty(c) && "function" === typeof a[c] && (a[c] = fa);
    };
    V = function (a) {
      "undefined" === typeof a && (a = !1);
      (v || a) && c.disable(a);
      ...
      c.version =
        ...
        (c.html5Only
          ...
          : 9 === j
            ...
            : " (AS2/Flash 8)");
      8 < j
        ? ((c.defaultOptions = s(c.defaultOptions, c.flash9Options)),
          (c.features.buffering = !0),
          (c.defaultOptions = s(c.defaultOptions, c.movieStarOptions)),
      ...
      if (c.ok()) {
        ...
        if (t)
          c.oMC.className =
            F() +
            " movieContainer " +
            (null === a ? "swf_timedout" : "swf_error");
        c.didFlashBlock = !0;
        A({ type: "ontimeout", ignoreInit: !0, error: d });
        D(d);
      }
    };
    ha = function (a, c, e) {
      "undefined" === typeof q[a] && (q[a] = []);
      q[a].push({ method: c, scope: e || null, fired: !1 });
    };
    A = function (a) {
      a || (a = { type: "onready" });
      if ((!o && a && !a.ignoreInit) || ("ontimeout" === a.type && c.ok()))
        return !1;
      var d = { success: a && a.ignoreInit ? c.ok() : !v },
        e = a && a.type ? q[a.type] || [] : [],
        b = [],
        f,
        d = [d],
        i = t && c.useFlashBlock && !c.ok();
      ...
      if (b.length)
        for (a = 0, f = b.length; a < f; a++)
          if (
            (b[a].scope
              ? b[a].method.apply(b[a].scope, d)
              : b[a].method.apply(this, d),
            !i)
          )
            b[a].fired = !0;
      return !0;
      ...
      if (!a._hasTimer)
        ((a._hasTimer = !0),
          !ua &&
            ...
            (null === M &&
              0 === Z &&
              (M = H.setInterval(Fa, c.html5PollingInterval)),
            Z++));
    };
    Ea = function (a) {
      if (a._hasTimer)
        ((a._hasTimer = !1), !ua && c.html5PollingInterval && Z--);
    };
    Fa = function () {
      var a;
    ...
    Ia = function () {
      ...
      for (e in a)
        if (a.hasOwnProperty(e) && ("mp3" === e || "mp4" === e))
          if (((c.html5[e] = !1), a[e] && a[e].related))
    ...
    U = function (a, d) {
      ...
      if (I && J) return !1;
      if (c.html5Only)
        return (ia(), (c.oMC = Q(c.movieID)), R(), (J = I = !0), !1);
      var b = d || c.url,
        f = c.altURL || b,
        i;
      i = la();
      var g,
        ...
        m = null,
        m =
          (m = k.getElementsByTagName("html")[0]) &&
          m.dir &&
          m.dir.match(/rtl/i),
      ...
      if (
        null !== c.wmode &&
        (n.match(/msie 8/i) || (!x && !c.useHighPerformance)) &&
        ...
        ((b = k.createElement("div")),
          (h = [
            '<object id="' +
              ...
              '">',
            e("movie", d),
            e("AllowScriptAccess", c.allowScriptAccess),
            e("quality", i.quality),
            c.wmode ? e("wmode", c.wmode) : "",
            e("bgcolor", c.bgColor),
            e("hasPriority", "true"),
            c.debugFlash ? e("FlashVars", i.FlashVars) : "",
            "</object>",
          ].join("")));
      else
        for (g in ((b = k.createElement("embed")), i))
          i.hasOwnProperty(g) && b.setAttribute(g, i[g]);
      ma();
      j = F();
      if ((i = la()))
        if (((c.oMC = Q(c.movieID) || k.createElement("div")), c.oMC.id)) {
          l = c.oMC.className;
          c.oMC.className =
            (l ? l + " " : "movieContainer") + (j ? " " + j : "");
          c.oMC.appendChild(b);
          if (x)
            ((g = c.oMC.appendChild(k.createElement("div"))),
          ...
          if (!c.debugFlash)
            for (l in j) j.hasOwnProperty(l) && (c.oMC.style[l] = j[l]);
          try {
    ...
    T = function () {
      ...
      if (!h)
        (L
          ? (x ? (c.oMC.innerHTML = na) : c.oMC.appendChild(L),
            (L = null),
            (I = !0))
          : U(c.id, c.url),
          (h = c.getMovie(c.id)));
          ...
          c.audioFormats.hasOwnProperty(a) &&
            d.push(
              a +
                ": " +
                c.html5[a] +
                (!c.html5[a] && r && c.flash[a]
                  ? " (using flash)"
                  : c.preferFlash && c.flash[a] && r
                    ? " (preferring flash)"
                    : !c.html5[a]
                      ? " (" +
    ...
    K = function (a) {
      ...
      if (!c.useFlashBlock || !c.flashLoadTimeout || c.getMoviePercent())
        ((o = !0), v && (d = { type: !r && t ? "NO_FLASH" : "INIT_TIMEOUT" }));
      if (v || a) {
    ...
    R = function () {
      ...
      if (c.html5Only) {
        if (!o)
          (m.remove(g, "load", c.beginDelayedInit), (c.enabled = !0), K());
        return !0;
      }
      T();
      try {
        (h._externalInterfaceTest(!1),
          Aa(!0, c.flashPollingInterval || (c.useHighPerformance ? 10 : 50)),
          c.debugMode || h._disableDebug(),
          (c.enabled = !0),
          c.html5Only || m.add(g, "unload", fa));
      } catch (a) {
        return (
    ...
    sa = function () {
      "complete" === k.readyState &&
        (C(), k.detachEvent("onreadystatechange", sa));
      return !0;
    };
    ja = function () {
      ga = !0;
    ...
    k.addEventListener
      ? k.addEventListener("DOMContentLoaded", C, !1)
      : k.attachEvent
        ? k.attachEvent("onreadystatechange", sa)
