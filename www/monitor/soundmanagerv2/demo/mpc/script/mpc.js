...
var MPC = function () {
  ...
  this.showProgress = function () {
    ...
    if (self._getButton(this.sID).className != "loading")
      self._getButton(this.sID).className = "loading"; // a bit inefficient here..
  ...
  this.onload = function () {
    ...
    self._getButton(this.sID).title =
      "Sound ID: " + this.sID + " (" + this.url + ")";
  };
  ...
  this._keyHandler = function (e) {
    ...
    if (typeof self.keys[sChar] != "undefined")
      soundManager.play("s" + self.keys[sChar]);
  };
  ...
  this._showStatus = function (sID, n1, n2) {
    ...
    var offX =
      n2 > 0
        ? -self.progressWidth + parseInt((n1 / n2) * o.offsetWidth)
        : -self.progressWidth;
...
soundManager.flashVersion = window.location.toString().match(/#flash8/i)
  ? 8
  : 9;
...
soundManager.onready(function () {
  ...
  var soundURLs =
    "AMB_BD_1,AMB_FTM2,AMB_HHCL,AMB_HHOP,AMB_HHPD,AMB_HTM,AMB_LTM2,AMB_MTM,AMB_RIM1,AMB_SN13,AMB_SN_5,CHINA_1,CRASH_1,CRASH_5,CRASH_6,RIDE_1".split(
      ","
    );
